...
class ScraperFacade:
    ...
    def firefox_selenium_proxy_scrape(self, url: str):
    ...
    def chrome_selenium_proxy_scrape(self, url: str):
    ...
    def requests_proxy_scrape(self, url: str):
    ...
    def scrapy_proxy_scrape(self, url: str):
        pass
